...
public class EquipmentCalibrationService {
    ...
    public EquipmentCalibrationService(CalibrationSiteCurrencyDAO calibrationSiteCurrencyDAO, UserRepository userRepository, LocationMasterDAO locationMasterDAO, EquipmentDAO equipmentDAO, ReportsManager reportsManager, AccountService accountService, SiteService siteService, PersistWrapper persistWrapper, CommonServiceManager commonServiceManager) {
    ...
    private  EquipmentCalibrationBean getEquipmentCalibrationBean(int pk)
    {
    ...
    private  EquipmentCalibrationBean getEquipmentCalibrationBean(EquipmentOID equipmentOID)
    {
    ...
    private  void updateNextCaliberationDate(EquipmentOID equipmentOID,
