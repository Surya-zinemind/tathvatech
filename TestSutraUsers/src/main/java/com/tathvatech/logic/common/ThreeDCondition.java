 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public abstract class ThreeDCondition implements Condition
{
    private static final Logger logger = LoggerFactory.getLogger(ThreeDCondition.class);
    
    protected SurveyDefinition surveyDef;

    protected String subjectId;
    protected String keyId;
    protected String key2Id;
    protected String operator;
    protected String value;
    
    public ThreeDCondition(SurveyDefinition surveyDef)
    {
...
//    }
	...
	public void setKey2Id(String key2Id) 
	{
		this.key2Id = key2Id;
	}
    ...
    public void setConfiguration(Map paramMap)
    {
        ...
        String[] k2Val = (String[])paramMap.get("key2Id");
        if(k2Val != null)
        {
            key2Id = k2Val[0];
        }
    ...
    public void setConfiguration(Element element)
    {
        ...
        this.setKey2Id(element.getAttributeValue("key2Id"));
    ...
    public Element toXML()
    {
        ...
        if(key2Id != null)
        {
            element.setAttribute("key2Id", key2Id);
        }
        else
        {
            element.setAttribute("key2Id", "unknown");
        }
