...
private final  EmailServiceManager emailServiceManager;
    ...
    public EquipmentEmailSender(EmailServiceManager emailServiceManager, AuthorizationManager authorizationManager, AccountService accountService) {
    ...
    public void notifyApprovedEquipment(UserContext context, EquipmentBean equipmentBean) throws Exception
    {
    ...
    public  void sendEmailForEquipmentApproved(UserContext context, String subject, String text, String html,
                                                     EquipmentBean equipmentBean) throws Exception
    {
        List<Integer> sentList = new ArrayList<>();
        List<String> userListArr = new ArrayList<String>();
     ...
     */
    public void notifyCalibrationUpdated(UserContext context, EquipmentBean equipmentBean) throws Exception
    {
    ...
    public void sendEmailForCalibration(UserContext context, String subject, String text, String html,
                                               EquipmentBean equipmentBean) throws Exception
    {
        List<Integer> sentList = new ArrayList<>();
        List<String> userListArr = new ArrayList<String>();
