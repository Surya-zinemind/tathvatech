...
import com.tathvatech.equipmentcalibration.enums.SubforDBEnum;
import com.tathvatech.equipmentcalibration.report.ReportsManager;
import com.tathvatech.common.enums.EntityTypeEnum;
import com.tathvatech.common.exception.AppException;
import com.tathvatech.equipmentcalibration.enums.CalibrationStatusEnum;
import com.tathvatech.common.wrapper.PersistWrapper;
import com.tathvatech.equipmentcalibration.common.*;
...
import com.tathvatech.equipmentcalibration.dao.EquipmentDAO;
import com.tathvatech.equipmentcalibration.entity.*;
...
import com.tathvatech.equipmentcalibration.dao.CalibrationSiteCurrencyDAO;
import java.util.*;
...
public class EquipmentCalibrationServiceImpl implements EquipmentCalibrationService {
    private  final Logger logger = LoggerFactory.getLogger(EquipmentCalibrationServiceImpl.class);
    ...
    private final  EquipmentEmailSender equipmentEmailSender;

    private final PersistWrapper persistWrapper;
    private  final SubforDBEnum dbEnum;
    private final UserRepository userRepository;
    private final CommonServiceManager commonServiceManager;



    public EquipmentCalibrationServiceImpl(CalibrationSiteCurrencyDAO calibrationSiteCurrencyDAO, LocationMasterDAO locationMasterDAO, EquipmentDAO equipmentDAO, ReportsManager reportsManager, AuthorizationManager authorizationManager, AccountService accountService, SiteService siteService, EquipmentEmailSender equipmentEmailSender, PersistWrapper persistWrapper, SubforDBEnum dbEnum, UserRepository userRepository, CommonServiceManager commonServiceManager) {
        ...
        this.equipmentEmailSender = equipmentEmailSender;
    ...
    public  List<EquipmentBean> getEquipmentHistory(EquipmentOID equipmentOID)
    {
        ...
        return objList.stream().map(obj -> {
            ...
            if (obj.getCalibrationIntervalFk() != null)
                 bean.setCalibrationInterval((EquipmentCalibrationIntervalEnum)
                         dbEnum.getEnum(EquipmentCalibrationIntervalEnum.class, obj.getCalibrationIntervalFk()));
    ...
    public void updateNextCaliberationDate(EquipmentOID equipmentOID,
        ...
        if (calib != null)
        {
            if (calibrationInterval != null && calib.getCalibrationDate() != null)
            {
                ...
                cal.setTimeZone(context.getTimeZone());
    ...
    public  EquipmentCalibrationBean saveCalibrationData(UserContext context, EquipmentOID equipmentOID,
        ...
        EquipmentBean equipmentBean = getEquipmentBean(equipmentOID);
