...
public class ReportsManager
{
    ...
    private final  UserListReport userListReport;
    private final FormListReport formListReport;

    public ReportsManager(AuthorizationManager authorizationManager, PersistWrapper persistWrapper, UserListReport userListReport, FormListReport formListReport) {
        this.authorizationManager = authorizationManager;
        this.persistWrapper = persistWrapper;
        this.userListReport = userListReport;
...
*/
    public  ReportResponse runReport(UserContext context, ReportRequest reportRequest)
    {
       if (ReportTypes.UserListReport == reportRequest.getReportType())
        ...
        {
            EquipmentListReport report = new EquipmentListReport(persistWrapper, authorizationManager,context, reportRequest);
            return report.runReport();
