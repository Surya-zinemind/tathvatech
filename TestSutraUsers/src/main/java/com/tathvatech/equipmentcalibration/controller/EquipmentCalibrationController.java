package com.tathvatech.equipmentcalibration.controller;
import com.tathvatech.equipmentcalibration.Request.*;
...
import com.tathvatech.equipmentcalibration.service.EquipmentCalibrationService;
...
public class EquipmentCalibrationController {
  ...
  @PostMapping("/saveLocationMaster")
   ...
   @GetMapping("/getLocationsByName/{searchString}")
