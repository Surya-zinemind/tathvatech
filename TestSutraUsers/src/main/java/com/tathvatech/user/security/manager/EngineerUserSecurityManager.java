...
public class EngineerUserSecurityManager extends PlanSecurityManager
{
	private static final Logger logger = LoggerFactory.getLogger(EngineerUserSecurityManager.class);

//	protected EngineerUserSecurityManager(AccountService accountService) {
...
//					"MSG-PlanAccessDeniedMessageHeading",
//					"MSG-PlanAccessDeniedMessageBody", null, null);
//		}
...
//				List us = ProjectDelegate.getUsersForUnitInRole(unit.getPk(), sContext.getProjectOID(), DummyWorkstation.getOID(), User.ROLE_TESTER);
//				if(us.contains(user))
//				{
//					return true;
//				}
//				us = ProjectDelegate.getUsersForUnitInRole(unit.getPk(), sContext.getProjectOID(), DummyWorkstation.getOID(), User.ROLE_VERIFY);
//				if(us.contains(user))
//				{
//					return true;
//				}
...
//			{
//				UnitObj unit = ProjectDelegate.getUnitByPk(sContext.getUnitOID());
//				List us = ProjectDelegate.getUsersForUnitInRole(unit.getPk(), sContext.getProjectOID(), DummyWorkstation.getOID(), User.ROLE_VERIFY);
//				if(us.contains(user))
//				{
//					return true;
//				}
